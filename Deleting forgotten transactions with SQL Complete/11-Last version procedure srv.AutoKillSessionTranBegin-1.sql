...
BEGIN
	/*
		--definition of frozen transactions (lost ones that do not have active requests) with their subsequent removal
	*/
	...
	--list of sessions to delete (containing lost transactions)
	DECLARE @kills TABLE (
		SessionID INT
	);
